  ...
  return (
    <div className="container py-6 md:py-10 animate-pulse">
      ...
      <div className="mb-6 space-y-2">
        <div className="h-8 w-64 bg-hairline" />
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {Array.from({ length: 2 }).map((_, i) => (
          <div
            key={i}
            className="rounded-2xl border border-hairline bg-soft-cloud p-4 sm:p-5 space-y-3"
          >
      ...
      <div className="mt-6 rounded-2xl border border-hairline bg-soft-cloud p-4 sm:p-5">
        <div className="h-4 w-24 bg-hairline mb-3" />
