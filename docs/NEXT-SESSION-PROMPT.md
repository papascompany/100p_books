...
**2026-08-11 기준 런치 차단 항목 0건.** 마이그레이션 `0030`·`0031` 적용 완료,
결제(토스)·인쇄(Storige)·DB·CRON 키와 인쇄용 폰트(1종)·책 사이즈(3종)도 실측 확인됐다.
남은 것은 전부 선택 항목이다 — 토스 웹훅 URL 등록 · Resend · Upstash · 카카오 · Storige 통지.
운영 규칙 하나: **토스 콘솔 환불은 전액 취소만**(부분 취소는 앱이 의도적으로 무시한다).
